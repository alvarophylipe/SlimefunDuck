...
class ErrorReport<T : Throwable?> @JvmOverloads constructor(
     ...
     * [io.github.ducklin.implementation.items.SlimefunItem].
     *
     * @param throwable
     * The [Throwable] which caused this [ErrorReport].
     * @param l
    ...
    /**
     * This constructs a new [ErrorReport] for the given [io.github.ducklin.implementation.items.SlimefunItem].
     *
     * @param throwable
     * The [Throwable] which caused this [ErrorReport].
     * @param item
    ...
    private fun print(@Nonnull printer: Consumer<PrintStream?>) {
        ...
        try {
            PrintStream(file, StandardCharsets.UTF_8.name()).use { stream ->
                ...
                stream.println("  Slimefun v${Slimefun.version}")
            ...
            addon.javaPlugin.logger.log(
                Level.SEVERE,
                x
            ) { "An Error occurred while saving an Error-Report for Slimefun ${Slimefun.version}" }
        }
    }
