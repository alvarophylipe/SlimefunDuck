...
internal object StartupWarnings {
    ...
    @ParametersAreNonnullByDefault
    fun invalidMinecraftVersion(logger: Logger?, majorVersion: Int, slimefunVersion: String) {
        logger?.log(Level.SEVERE, BORDER)
        ...
        logger?.log(Level.SEVERE, PREFIX + "Minecraft {0}", java.lang.String.join(" / ", supportedVersions))
        logger?.log(Level.SEVERE, BORDER)
    }
