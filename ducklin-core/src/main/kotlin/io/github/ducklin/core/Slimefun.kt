...
import io.github.ducklin.core.services.AnalyticsService
import io.github.ducklin.core.services.AutoSavingService
import io.github.ducklin.core.services.BackupService
import io.github.ducklin.core.services.BlockDataService
import io.github.ducklin.core.services.CustomItemDataService
import io.github.ducklin.core.services.CustomTextureService
import io.github.ducklin.core.services.LocalizationService
import io.github.ducklin.core.services.MetricsService
import io.github.ducklin.core.services.MinecraftRecipeService
import io.github.ducklin.core.services.PerWorldSettingsService
import io.github.ducklin.core.services.PermissionsService
import io.github.ducklin.core.services.ThreadService
import io.github.ducklin.core.services.UpdaterService
import io.github.ducklin.core.services.github.GitHubService
...
import io.github.ducklin.migration.tasks.armor.RainbowArmorTask
...
import io.github.ducklin.migration.Storage
import io.github.ducklin.migration.LegacyStorage
...
class Slimefun : SlimefunAddon() {
    ...
    private val config = Config(this, "config.yml")
...
//    }
    ...
    /**
     * This (re)loads every [io.github.ducklin.migration.utils.tags.SlimefunTag].
     */
...
//            SlimefunItemSetup.setup(this)
    ...
    companion object {
        ...
        /**
         * This returns our [io.github.ducklin.migration.networks.NetworkManager] which is responsible
         * for handling the Cargo and Energy networks.
         *
         * @return Our [io.github.ducklin.migration.networks.NetworkManager] instance
         */
        @JvmStatic
        @Nonnull
