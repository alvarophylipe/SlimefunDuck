package io.github.ducklin.migration.utils;
...
import io.github.ducklin.menu.ClickAction;
...
public final class ChestMenuUtils {
    ...
    private static final ItemStack UI_BACKGROUND = new DucklinItemStack("_UI_BACKGROUND", Material.GRAY_STAINED_GLASS_PANE, " ").item();
    private static final ItemStack INPUT_SLOT = new DucklinItemStack("_UI_INPUT_SLOT", Material.CYAN_STAINED_GLASS_PANE, " ").item();
    private static final ItemStack OUTPUT_SLOT = new DucklinItemStack("_UI_OUTPUT_SLOT", Material.ORANGE_STAINED_GLASS_PANE, " ").item();

    private static final ItemStack NO_PERMISSION = new DucklinItemStack("_UI_NO_PERMISSION", Material.BARRIER, "No Permission").item();
    private static final ItemStack NOT_RESEARCHED = new DucklinItemStack("_UI_NOT_RESEARCHED", Material.BARRIER, "Not researched").item();

    private static final ItemStack BACK_BUTTON = new DucklinItemStack("_UI_BACK", Material.ENCHANTED_BOOK, "&7\u21E6 Back", meta -> meta.addItemFlags(ItemFlag.HIDE_ENCHANTS)).item();
    private static final ItemStack MENU_BUTTON = new DucklinItemStack("_UI_MENU", Material.COMPARATOR, "&eSettings / Info", "", "&7\u21E8 Click to see more").item();
    private static final ItemStack SEARCH_BUTTON = new DucklinItemStack("_UI_SEARCH", Material.NAME_TAG, "&bSearch").item();
    private static final ItemStack WIKI_BUTTON = new DucklinItemStack("_UI_WIKI", Material.KNOWLEDGE_BOOK, "&3Slimefun Wiki").item();

    private static final ItemStack PREV_BUTTON_ACTIVE = new DucklinItemStack("_UI_PREVIOUS_ACTIVE", Material.LIME_STAINED_GLASS_PANE, "&r\u21E6 Previous Page").item();
    private static final ItemStack NEXT_BUTTON_ACTIVE = new DucklinItemStack("_UI_NEXT_ACTIVE", Material.LIME_STAINED_GLASS_PANE, "&rNext Page \u21E8").item();
    private static final ItemStack PREV_BUTTON_INACTIVE = new DucklinItemStack("_UI_PREVIOUS_INACTIVE", Material.BLACK_STAINED_GLASS_PANE, "&8\u21E6 Previous Page").item();
    private static final ItemStack NEXT_BUTTON_INACTIVE = new DucklinItemStack("_UI_NEXT_INACTIVE", Material.BLACK_STAINED_GLASS_PANE, "&8Next Page \u21E8").item();
    ...
    public static @Nonnull ChestMenu.MenuClickHandler getEmptyClickHandler() {
