...
public class IncompatibleItemHandlerException extends RuntimeException {
    ...
    /**
     * Constructs a new {@link IncompatibleItemHandlerException} with the given {@link DuckItem} and
     * {@link ItemHandler}
     * 
     * @param message
    ...
    public IncompatibleItemHandlerException(String message, DuckItem item, ItemHandler handler) {
