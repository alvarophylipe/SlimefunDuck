...
class Slimefun : JavaPlugin(), SlimefunAddon {
    ...
    private val isVersionUnsupported: Boolean
        /**
         * This method checks for the [MinecraftVersion] of the [Server].
         * If the version is unsupported, a warning will be printed to the console.
         *
         * @return Whether the [MinecraftVersion] is unsupported
         */
        get() {
            try {
    ...
    /**
     * This (re)loads every [io.github.thebusybiscuit.slimefun4.utils.tags.SlimefunTag].
     */
    ...
    companion object {
        ...
        val supportedVersions: MutableCollection<String?>
            /**
             * This private method gives us a [Collection] of every [MinecraftVersion]
        ...
        /**
         * This returns the [java.util.logging.Logger] instance that Slimefun uses.
         *
         *
         * **Any [SlimefunAddon] should use their own [java.util.logging.Logger] instance!**
         *
         * @return Our [java.util.logging.Logger] instance
         */
        @JvmStatic
        @Nonnull
        fun logger(): Logger? {
        ...
        val gPSNetwork: GPSNetwork
             ...
             * The [GPSNetwork] is responsible for handling any GPS-related
             * operations and for managing any [io.github.thebusybiscuit.slimefun4.api.geo.GEOResource].
             *
             * @return Our [GPSNetwork] instance
             */
            get() {
                validateInstance()
        ...
        val localization: LocalizationService
             ...
             *
             * @return The [LocalizationService] of Slimefun
             */
            get() {
                validateInstance()
        ...
        val minecraftRecipeService: MinecraftRecipeService
             ...
             *
             * @return Slimefun's [MinecraftRecipeService] instance
             */
            get() {
                validateInstance()
         ...
         * [org.bukkit.World], such as disabling a [io.github.thebusybiscuit.slimefun4.api.items.SlimefunItem] in a
         * specific [org.bukkit.World].
         *
         * @return Our instance of [PerWorldSettingsService]
         */
        @JvmStatic
        @Nonnull
        ...
        /**
         * This returns our [HologramsService] which handles the creation and
         * cleanup of any holograms.
         *
         * @return Our instance of [HologramsService]
         */
        @JvmStatic
        @Nonnull
         ...
         *
         * @return Our instance of [SoundService]
         */
        @JvmStatic
        @Nonnull
         ...
         *
         * @return Our instance of [IntegrationsManager]
         */
        @JvmStatic
        @Nonnull
        ...
        val updater: UpdaterService
             ...
             *
             * @return The [UpdaterService] for Slimefun
             */
            get() {
                validateInstance()
         ...
         *
         * @return The [MetricsService] for Slimefun
         */
        @JvmStatic
        @Nonnull
         ...
         *
         * @return The [AnalyticsService] for Slimefun
         */
        @JvmStatic
        @Nonnull
         ...
         *
         * @return The [GitHubService] for Slimefun
         */
        @JvmStatic
        @Nonnull
        ...
        /**
         * This returns our [NetworkManager] which is responsible
         * for handling the Cargo and Energy networks.
         *
         * @return Our [NetworkManager] instance
         */
        @JvmStatic
        @Nonnull
        ...
        /**
         * This returns our instance of the [SlimefunProfiler], a tool that is used
         * to analyse performance and lag.
         *
         * @return The [SlimefunProfiler]
         */
        @JvmStatic
        @Nonnull
         ...
         * **Do not use this if you're an addon. Please make your own [ThreadService].**
         *
         * @return The [ThreadService] for Slimefun
         */
        @JvmStatic
        @Nonnull
