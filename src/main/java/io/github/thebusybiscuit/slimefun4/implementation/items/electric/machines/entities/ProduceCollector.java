...
public class ProduceCollector extends AContainer implements RecipeDisplayItem {
    ...
    public @Nonnull List<ItemStack> getDisplayRecipes() {
        ...
        displayRecipes.add(CustomItemStack.create(Material.BUCKET, null, "&fRequer &bVaca &fpróxima"));
        displayRecipes.add(new ItemStack(Material.MILK_BUCKET));

        if (Slimefun.getMinecraftVersion().isAtLeast(MinecraftVersion.MINECRAFT_1_17)) {
            displayRecipes.add(CustomItemStack.create(Material.BUCKET, null, "&fRequer &bCabra &fpróxima"));
            displayRecipes.add(new ItemStack(Material.MILK_BUCKET));
        }

        displayRecipes.add(CustomItemStack.create(Material.BOWL, null, "&fRequer &bVaca Cogumelo &fpróxima"));
