package io.github.ducklin.implementation.setup;
...
import io.github.ducklin.implementation.items.armor.RainbowArmorPiece;
import io.github.ducklin.implementation.items.armor.SlimefunArmorPiece;
import io.github.ducklin.implementation.items.backpacks.EnderBackpack;
import io.github.ducklin.implementation.items.blocks.EnhancedFurnace;
import io.github.ducklin.implementation.items.blocks.OutputChest;
import io.github.ducklin.implementation.items.food.DietCookie;
import io.github.ducklin.implementation.items.food.FortuneCookie;
import io.github.ducklin.implementation.items.food.Juice;
import io.github.ducklin.implementation.items.food.MeatJerky;
import io.github.ducklin.implementation.items.magical.SoulboundItem;
import io.github.ducklin.implementation.items.misc.AlloyIngot;
import io.github.ducklin.implementation.items.misc.GoldIngot;
import io.github.ducklin.implementation.items.tools.PortableCrafter;
import io.github.ducklin.implementation.items.tools.PortableDustbin;
...
import io.github.ducklin.implementation.items.autocrafters.ArmorAutoCrafter;
...
import io.github.ducklin.implementation.items.electric.gadgets.MultiTool;
import io.github.ducklin.implementation.items.electric.gadgets.Multimeter;
import io.github.ducklin.implementation.items.electric.gadgets.SolarHelmet;
import io.github.ducklin.implementation.items.electric.generators.BioGenerator;
import io.github.ducklin.implementation.items.electric.generators.CoalGenerator;
import io.github.ducklin.implementation.items.electric.generators.CombustionGenerator;
import io.github.ducklin.implementation.items.electric.generators.LavaGenerator;
import io.github.ducklin.implementation.items.electric.generators.MagnesiumGenerator;
import io.github.ducklin.implementation.items.electric.generators.SolarGenerator;
import io.github.ducklin.implementation.items.electric.machines.AutoAnvil;
import io.github.ducklin.implementation.items.electric.machines.AutoBrewer;
import io.github.ducklin.implementation.items.electric.machines.AutoDrier;
import io.github.ducklin.implementation.items.electric.machines.CarbonPress;
import io.github.ducklin.implementation.items.electric.machines.ChargingBench;
import io.github.ducklin.implementation.items.electric.machines.ElectricDustWasher;
import io.github.ducklin.implementation.items.electric.machines.ElectricFurnace;
import io.github.ducklin.implementation.items.electric.machines.ElectricGoldPan;
import io.github.ducklin.implementation.items.electric.machines.ElectricIngotFactory;
import io.github.ducklin.implementation.items.electric.machines.ElectricIngotPulverizer;
import io.github.ducklin.implementation.items.electric.machines.ElectricOreGrinder;
import io.github.ducklin.implementation.items.electric.machines.ElectricPress;
import io.github.ducklin.implementation.items.electric.machines.ElectricSmeltery;
import io.github.ducklin.implementation.items.electric.machines.ElectrifiedCrucible;
import io.github.ducklin.implementation.items.electric.machines.FluidPump;
import io.github.ducklin.implementation.items.electric.machines.FoodComposter;
import io.github.ducklin.implementation.items.electric.machines.FoodFabricator;
import io.github.ducklin.implementation.items.electric.machines.Freezer;
import io.github.ducklin.implementation.items.electric.machines.HeatedPressureChamber;
import io.github.ducklin.implementation.items.electric.machines.Refinery;
import io.github.ducklin.implementation.items.electric.machines.accelerators.AnimalGrowthAccelerator;
import io.github.ducklin.implementation.items.electric.machines.accelerators.CropGrowthAccelerator;
import io.github.ducklin.implementation.items.electric.machines.accelerators.TreeGrowthAccelerator;
import io.github.ducklin.implementation.items.electric.machines.enchanting.AutoDisenchanter;
import io.github.ducklin.implementation.items.electric.machines.enchanting.AutoEnchanter;
import io.github.ducklin.implementation.items.electric.machines.enchanting.BookBinder;
import io.github.ducklin.implementation.items.electric.machines.entities.AutoBreeder;
import io.github.ducklin.implementation.items.electric.machines.entities.ExpCollector;
import io.github.ducklin.implementation.items.electric.machines.entities.IronGolemAssembler;
import io.github.ducklin.implementation.items.electric.machines.entities.ProduceCollector;
// import io.github.thebusybiscuit.slimefun4.implementation.items.electric.machines.entities.WitherAssembler;
import io.github.ducklin.implementation.items.electric.reactors.NetherStarReactor;
import io.github.ducklin.implementation.items.electric.reactors.NuclearReactor;
import io.github.ducklin.implementation.items.magical.runes.ElementalRune;
import io.github.ducklin.implementation.items.magical.runes.EnchantmentRune;
import io.github.ducklin.implementation.items.magical.runes.SoulboundRune;
import io.github.ducklin.implementation.items.magical.runes.VillagerRune;
import io.github.ducklin.implementation.items.magical.staves.StormStaff;
import io.github.ducklin.implementation.items.magical.staves.WaterStaff;
import io.github.ducklin.implementation.items.magical.staves.WindStaff;
...
import io.github.ducklin.implementation.items.multiblocks.ArmorForge;
import io.github.ducklin.implementation.items.multiblocks.AutomatedPanningMachine;
import io.github.ducklin.implementation.items.multiblocks.Compressor;
import io.github.ducklin.implementation.items.multiblocks.EnhancedCraftingTable;
import io.github.ducklin.implementation.items.multiblocks.GrindStone;
import io.github.ducklin.implementation.items.multiblocks.Juicer;
import io.github.ducklin.implementation.items.multiblocks.MagicWorkbench;
import io.github.ducklin.implementation.items.multiblocks.MakeshiftSmeltery;
import io.github.ducklin.implementation.items.multiblocks.OreCrusher;
import io.github.ducklin.implementation.items.multiblocks.OreWasher;
import io.github.ducklin.implementation.items.multiblocks.PressureChamber;
import io.github.ducklin.implementation.items.multiblocks.Smeltery;
import io.github.ducklin.implementation.items.multiblocks.TableSaw;
import io.github.ducklin.implementation.items.multiblocks.miner.AdvancedIndustrialMiner;
import io.github.ducklin.implementation.items.multiblocks.miner.IndustrialMiner;
import io.github.ducklin.implementation.items.teleporter.SharedActivationPlate;
import io.github.ducklin.implementation.items.teleporter.TeleporterPylon;
import io.github.ducklin.migration.utils.compatibility.VersionedPotionEffectType;
import io.github.ducklin.implementation.items.*;
...
//                new ItemStack[] {null, null, null, null, CustomItemStack.create(SlimefunUtils.getCustomHead(HeadTexture.IRON_GOLEM.texture), "&aIron Golem"), null, null, null, null})
//                .register(plugin);
//
