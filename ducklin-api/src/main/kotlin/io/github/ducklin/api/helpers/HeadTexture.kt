 ...
 */
enum class HeadTexture(texture: String) {
    ...
    init {
        require(texture.isBlank()) { "Texture cannot be null"}
        require(CommonPatterns.HEXADECIMAL.matcher(texture).matches()) { "Textures must be in hexadecimal."}
