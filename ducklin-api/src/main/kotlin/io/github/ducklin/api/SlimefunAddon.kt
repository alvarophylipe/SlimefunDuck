...
import io.github.ducklin.api.items.SlimefunItem
import kotlin.text.contains

/**
 * This is a very basic interface that will be used to identify
 * the [io.github.thebusybiscuit.slimefun4.implementation.Slimefun] that registered a [SlimefunItem].
 *
...
abstract class SlimefunAddon : JavaPlugin() {
     ...
     *
     * @return Whether this [SlimefunAddon] depends on the given [io.github.thebusybiscuit.slimefun4.implementation.Slimefun]
     */
    fun hasDependency(@Nonnull dependency: String): Boolean {
        ...
        return dependency contains description.depend || dependency contains description.softDepend
    }
}